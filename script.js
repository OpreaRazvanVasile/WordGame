...
function questionBackgroundChange(url, size) {
  question.style.backgroundImage = url;
  question.style.backgroundSize = size;
}

function changeDesktopBackground(url, procent) {
  document.body.style.backgroundImage = url;
  document.body.style.backgroundSize = procent;
  ...
  function checkClickEvent() {
    ...
    if (!wordImput) {
      ...
      if (score > highscore) {
        ...
        scoreContent();
        highscoreContent();
        title.textContent = 'Ghiceste Cuvantul👏???';
      ...
      function giffStyle() {
        question.style.backgroundSize = '320px 274px';
        question.style.transition = 'background 3.8s';
      }
...
function againBtn() {
  ...
  highscore;
  highscoreContent();
  displayMessage('Incearca sa Ghicesti 😊');
